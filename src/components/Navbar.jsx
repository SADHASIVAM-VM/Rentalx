  ...
  return (
    <div className={`px-3 ${viewScroll ? "glass" : ""}`}>
      <div className="flex justify-between items-center  h-16 ">
        ...
        <div className="">
          {!isOpen ? (
            <p className="logotxt font-extrabold text-xl showAnimation">
              RENTAL<span className=" text-green-500">X</span>
            </p>
          ) : (
        ...
        <div className="space-x-2 items-center flex ">
          <button className="p-2 px-3  rounded-full border-gray-300 hover:bg-green-600 ">
            <PhoneCall width={"20px"} />
          </button>
          <button className="p-2 px-3 rounded-md border border-[#4a4a4a] text-sm hover:border-green-600 hidden md:block">
            signup
          </button>
        </div>
      </div>
